...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($meno)) { array_push($errors, "Username is required"); }
  if (empty($priezvisko)) { array_push($errors, "Username is required"); }
  if (empty($adresa)) { array_push($errors, "Username is required"); }
  if (empty($telefon)) { array_push($errors, "Username is required"); }
