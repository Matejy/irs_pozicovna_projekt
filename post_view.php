...
// post_view.php
include 'mysql.php';
$result = mysqli_safe_query('SELECT * FROM posts WHERE id=%s LIMIT 1', $_GET['id']);
...
echo '<hr/>';
$result = mysqli_safe_query('SELECT * FROM comments WHERE post_id=%s ORDER BY date ASC', $_GET['id']);
echo '<ol id="comments">';
